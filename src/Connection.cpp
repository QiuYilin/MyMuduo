...
#include "Socket.h"
#include "utils.h"
Connection::Connection(EventLoop* loop, int sockfd, const InetAddr& loaclAddr,
...
void Connection::handleClose() {
  ...
  printf("channel_->disableAll(); is end ..... fd= %d, channel_->Event()= %d\n",
         channel_->Fd(), channel_->Event());
